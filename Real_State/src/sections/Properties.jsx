  ...
  return (
    <div className={`${darkMode ? " dark bg-black" : "light bg-transparent"}`}>
      ...
      w-full flex flex-col justify-center items-start gap-10'>
        ...
        {/* properties grisd start from here */}

        <div id='grid-box' className='w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8 cursor-pointer'>

          {
            property.map((item, index) => (
              <div data-aos='zoom-in' data-aos-delay='200' key={index}
                className='bg-white dark:bg-gray-800 rounded-xl w-full overflow-hidden'>

                <div id='image-box' className='bg-cover bg-center h-62.5 rounded-xl 
                  p-4 flex flex-col justify-between items-start' style={{ backgroundImage: `url(${item.images})` }}>
                ...
                <div className='px-6 py-3 flex flex-col justify-center items-start gap-2 w-full'>
                  ...
                  <div className='w-full border-t border-gray-200 pt-4 mt-8'>
