  ...
  return (
    ...
    grid-cols-1 justify-center items-center gap-10`}>
        ...
        <div className='flex flex-col justify-center items-start gap-8'>
          ...
          >Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet ipsum, iusto reprehenderit nesciunt sunt quisquam quidem sed nisi perferendis adipisci illo. Tempora pariatur necessitatibus perferendis?</p>
          ...
          <div className='w-full'>
            <button className='bg-red-600  dark:bg-red-700 hover:bg-black
             ...
             font-semibold rounded-xl cursor-pointer transform hover: scale-110 transition-transform duration-300'>
              Read More
            </button>
          </div>
        </div>
