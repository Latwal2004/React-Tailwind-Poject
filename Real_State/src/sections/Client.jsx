    ...
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
      <section id="testimonials" className='lg:w-[95%] w-full h-fit m-auto bg-cover
        ...
        <div className='flex flex-col justify-center items-start gap-4'>
          ...
          <h1 data-aos="zoom-in" className='text-black dark:text-white text-[40px] font-semibold
          leading-15'>What Our Clients <br />Saying About Us</h1>
        </div>
        ...
        justify-center items-center gap-8 w-full'>
          {
            client.map((item,index) =>(
              <div className='bg-white dark:bg-gray-900 dark:hover:bg-gray-800  hover:bg-red-100 cursor-pointer
              p-12 flex flex-col justify-center items-center gap-6 rounded-xl w-full'>
                <div className='flex justify-start items-center w-full gap-4'>
                  <img src={item.image} alt='' className='w-22.5 transform hover:scale-110 transition-transform duration-300'/>
